            ...
            <div className="mb-20">
                <Link href="/" className="group inline-block">
                    <div className="flex items-center gap-2 mb-2">
                        <div className="w-6 h-px bg-[#B89E7B] group-hover:w-12 transition-all duration-700" />
                        <span className="text-[10px] uppercase tracking-[0.6em] font-sans font-bold text-[#B89E7B]">Studio</span>
                    </div>
                            ...
                            >
                                <div className="flex items-center gap-5 relative z-10">
                                    <item.icon
                                        ...
                                        className={cn(
                                            ...
                                            isActive ? "text-[#B89E7B]" : "text-[#CCC] group-hover:text-[#B89E7B]"
                                        )}
                                    />
                                ...
                                {isActive && (
                                    <motion.div
                                        ...
                                        className="absolute left-0 w-1 h-full bg-[#B89E7B] z-10"
                                    />
                                )}
                            </Link>
                        );
            ...
            <div className="pt-10 border-t border-[#EAE6DF]">
                <div className="mb-8">
                    <div className="p-6 bg-[#F9F7F2] border border-[#EAE6DF] relative group overflow-hidden">
                        <Compass className="absolute -right-4 -bottom-4 text-[#B89E7B]/10 w-24 h-24 group-hover:rotate-45 transition-transform duration-1000" />
                        <p className="text-[9px] uppercase tracking-widest text-[#B89E7B] font-sans font-bold mb-2">Live Environment</p>
