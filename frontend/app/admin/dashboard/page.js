...
export default function DashboardPage() {
        ...
        return (
            <div className="flex items-center justify-center min-h-[80vh]">
                <div className="flex flex-col items-center gap-6">
                    <div className="w-12 h-px bg-[#B89E7B] animate-[width_2s_ease-in-out_infinite]" />
                    <span className="text-[10px] uppercase tracking-[0.5em] text-[#B89E7B] font-bold">Initializing Archive</span>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="w-full max-w-[1400px] mx-auto px-6 lg:px-12">
            ...
            >
                <div className="max-w-2xl">
                    <div className="flex items-center gap-3 mb-4">
                        <div className="w-8 h-px bg-[#B89E7B]" />
                        <span className="text-[10px] uppercase tracking-[0.5em] text-[#B89E7B] font-bold">Studio Matrix | v1.0</span>
                    </div>
            ...
            <motion.div
                variants={item}
                className="md:col-span-2 lg:col-span-2 bg-[#B89E7B] p-10 flex flex-col justify-between text-white group cursor-pointer hover:bg-[#2D2926] transition-colors duration-700"
            >
                <div>
