    ...
    return (
        <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-[#F9F7F2]">
            ...
            <div className="flex items-center justify-center p-8 lg:p-24 relative overflow-hidden order-2 lg:order-1">
                ...
                >
                    <div className="mb-12">
                        <span className="script-font text-[#B89E7B] text-2xl block mb-2">Join the Studio</span>
                    ...
                    <div className="mt-12 flex flex-col items-center gap-6">
                        ...
                        <p className="text-[10px] text-[#999] font-sans uppercase tracking-[0.25em]">
                            Already Have Access?{" "}
                            <Link href="/admin/login" className="text-[#B89E7B] hover:text-[#2D2926] transition-colors font-bold underline underline-offset-4">
                                Log In
                            </Link>
                        </p>
                    </div>
