    ...
    return (
        <div className="max-w-7xl mx-auto">
            <header className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                <div>
                    <span className="script-font text-[#31275c] text-2xl block mb-2">Management</span>
                ...
                <div className="relative w-full md:w-80">
                    ...
                    <input
                        ...
                        className="w-full pl-12 pr-4 py-3 bg-white border border-[#EAE6DF] focus:border-[#31275c] outline-none rounded font-sans text-sm transition-colors"
                        value={search}
            ...
            <div className="bg-white rounded-lg border border-[#EAE6DF] overflow-hidden shadow-sm">
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-5 space-y-1">
                                            <div className="flex items-center gap-2 text-xs text-[#6B6560]">
                                                <Mail size={12} className="text-[#31275c]" />
                                                {enquiry.email}
                                            </div>
                                            <div className="flex items-center gap-2 text-xs text-[#6B6560]">
                                                <Phone size={12} className="text-[#31275c]" />
                                                {enquiry.phoneNumber}
                                            </div>
                                        </td>
                                        <td className="px-6 py-5">
                                            <span className="text-[10px] uppercase tracking-widest px-2 py-1 bg-[#F9F7F2] text-[#31275c] border border-[#EAE6DF] rounded font-bold">
                                                {enquiry.projectType}
                                            </span>
                                        </td>
                                        <td className="px-6 py-5">
                ...
                {enquiries.length === 0 && !loading && (
                    <div className="py-20 text-center">
                        <span className="script-font text-[#31275c] text-2xl block mb-2">Quiet Studio</span>
